                                                    ...
                                                    <div class="row m-l-0 m-r-0">
                                                        <div class="col-sm-4 bg-c-lite-green user-profile">
                                                            <div class="card-block text-center text-white">
                                                                ...
                                                                <h6 class="f-w-600">{otSalaries.name}</h6>
                                                                <p>{otSalaries.position}</p>
                                                            ...
                                                            <div class="card-block">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400">{otSalaries.name}</h6>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">position</p>
                                                                        <h6 class="text-muted f-w-400">{otSalaries.position}</h6>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400">{otSalaries.email}</h6>
                                                                    </div>
                                                                    {/* <div class="col-sm-6">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <h6 class="text-muted f-w-400">{otSalaries.salary}</h6>
                                                                    </div>

                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">No of OT hours</p>
                                                                        <h6 class="text-muted f-w-400">{otSalaries.noOFOThours}</h6>
                                                                    </div>

                                                                    <div class="col-sm-6">
                                                                        <p class="m-b-10 f-w-600">Net Salary</p>
                                                                        <h6 class="text-muted f-w-400">{otSalaries.oTnetSalary}</h6>
                                                                    </div>
